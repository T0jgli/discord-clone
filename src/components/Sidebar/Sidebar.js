    ...
    <>
      <div
        className={
          mobile
            ? sidebarmobile
              ? "sidebar__mobile sidebar__div"
              : "sidebar__mobileopen sidebar__div"
            : "sidebar__div"
        }
      >
        <div className={"sidebar"}>
          ...
          >
            ...
            <ExpandMoreIcon
              className={
                Boolean(menu)
                  ? "sidebar__menuiconshowed sidebar__menuicon"
                  : "sidebar__menuicon"
              }
            />
            <Navbar
          ...
          <div className="sidebar__channels">
            <Scrollbars
              ...
              renderThumbVertical={() => (
                <div
                  style={{ backgroundColor: "#212121", borderRadius: "5px" }}
                />
              )}
            >
              {categories.length > 0 ? (
