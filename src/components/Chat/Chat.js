      ...
      if (image.type.includes("image")) {
        ...
        const uploadtask = storage
          .ref(
            `images/${replaceAt(
              image.name,
              image?.name.toString().lastIndexOf("."),
              "__" + today + "."
            )}`
          )
          .put(image);
  ...
  return (
    <>
      ...
      >
        ...
        <Scrollbars
          renderThumbVertical={() => (
            <div style={{ backgroundColor: "#212121", borderRadius: "5px" }} />
          )}
        >
              ...
              <Grow in={Boolean(chatBottomPopup)}>
                <div className="chat__filediv">
                  <Button
                    ...
                    style={{ fontWeight: "bold", padding: "11px" }}
                  >
                    {language === "en"
                      ? "File / Photo upload"
                      : "Fájl / Kép feltöltés"}
          ...
          {image && (
            <Grow in={Boolean(image)}>
              <div className="chat__filediv">
                ...
                <Tooltip
                  title={language === "hu" ? "Fájl törlése" : "Delete file"}
                  placement="right"
                >
                  <IconButton
                    onClick={() => {
                      ...
                      dispatch(
                        setsnackbar({
                          snackbar: {
                            ...
                            type: "info",
                            hu: `${
                              image?.type.includes("image") ? "Fénykép" : "Fájl"
                            } törölve.`,
                            en: `${
                              image?.type.includes("image") ? "Photo" : "File"
                            } deleted.`,
                          },
                        })
                      );
          ...
          onDragOver={(file) =>
            setfiledroptext(
              language === "en"
                ...
                : "Húzza ide a fájlt a feltöltéshez!"
            )
          }
          ...
          <div className="chat__input">
            {chatBottomPopup ? (
              <CancelIcon
                ...
                className={
                  channelId ? "chat__inputfilebutton" : "chat__disabledsendbtn"
                }
                fontSize="large"
                onClick={() => {
                ...
                <TextareaAutosize
                  ...
                  placeholder={
                    filedroptext
                      ...
                      ? image.name
                      : Boolean(selectedProgrammingLanguageArray) &&
                        `Programkód (${selectedProgrammingLanguageArray}): #` +
                          channelname
                  }
                  disabled={!channelId}
