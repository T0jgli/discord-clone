...
function geturl(message) {
  ...
  if (exactprefix) {
    for (
      let index = message.indexOf(exactprefix);
    ...
    <>
      ...
      >
        ...
        <div className="message__info">
          ...
          {!edit ? (
            Boolean(hasCode) ? (
              <SyntaxHighlighter
                customStyle={{ borderRadius: "0.6rem" }}
                wrapLines={true}
                language={hasCode}
                style={vs2015}
              >
          ...
          {fileurl && (
            <>
              ...
              <Tooltip
                title={
                  language === "hu" ? "Fájl URL másolása" : "Copy file URL"
                }
                placement="right"
              >
                <IconButton
      ...
      >
        <Paper
          ...
          className="message__editmenu"
        >
          <Tooltip
            title={language === "hu" ? "Üzenet szerkeszrése" : "Edit message"}
            placement="bottom"
          >
            <IconButton
              onClick={() => {
          ...
          <Tooltip
            title={language === "hu" ? "Üzenet törlése" : "Delete message"}
            placement="bottom"
          >
            <IconButton
              onClick={() => {
