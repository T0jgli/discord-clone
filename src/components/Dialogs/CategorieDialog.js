...
import {
    Button, Dialog, DialogContent, DialogTitle, DialogActions, TextField, Switch,
        ...
        <Dialog TransitionComponent={Grow} open={categoriemenu} onClose={() => setcategoriemenu(false)}>
            ...
            <TabPanel value={tab} index={0}>
                ...
                <form style={{ margin: "10px" }} onSubmit={(e) => { e.preventDefault(); handleaddcategorie(categoriename) }}>
                    <TextField variant="filled" autoFocus={window.innerWidth < 768 ? false : true} value={categoriename} fullWidth
