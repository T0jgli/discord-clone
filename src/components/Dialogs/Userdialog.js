    ...
    >
      <DialogContent>
        {dialog?.user?.photoUrl || dialog?.user?.photo ? (
          <img
            src={dialog?.user?.photoUrl || dialog?.user?.photo}
            alt="userphoto"
        ...
        <DialogTitle>
          <span style={{ fontWeight: "bold" }}>
            {dialog?.user?.newusername || dialog?.user?.displayname}
          </span>
          <br />
          {dialog?.user?.newusername && (
            <Fade in>
              <span>
                ({dialog?.user?.displayname || dialog?.user?.newusername})
              </span>
            </Fade>
          )}
        </DialogTitle>
        <DialogContentText>
          ...
          >
            ...
            <TimeAgo
              datetime={lastlogintime.toLocaleString("hu-HU")}
              locale={language === "hu" ? "hu" : "en"}
            />
          </span>
        </DialogContentText>
        {avatar && (
          <DialogContentText style={{ color: "gray", fontStyle: "italic" }}>
